...
class PhotoLostPetForm extends StatefulWidget {
  @override
  _PhotoLostPetFormState createState() => _PhotoLostPetFormState();
}

class _PhotoLostPetFormState extends State<PhotoLostPetForm> {
  File? _image;
